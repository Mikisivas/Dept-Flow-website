...
| HOD | Overview, at-risk list, per-course exam eligibility, and grace periods. |

**Still on fixtures in `src/lib/data/queries.ts`:** the HOD's waivers, disputes
and lecturer-oversight screens, most admin screens, notifications, password
...
`supabase/tests/schema_test.sql` (116 assertions, run in the SQL Editor).
