...
input string InpAsianSession      = "1900-0300";    // Asian Session (Tokyo 0800-1600, in NY time)
input string InpLondonSession     = "0300-1100";    // London Session (London 0800-1600, in NY time)
input string InpNewYorkSession    = "0800-1600";    // New York Session (NY cash hours)
input int    InpCustomStartHour   = 8;              // Custom Start Hour (session timezone)
input int    InpCustomStartMinute = 0;              // Custom Start Minute
input int    InpCustomEndHour     = 12;             // Custom End Hour (session timezone)
